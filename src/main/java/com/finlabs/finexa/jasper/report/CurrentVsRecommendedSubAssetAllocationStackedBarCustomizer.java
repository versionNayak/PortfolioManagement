...
public class CurrentVsRecommendedSubAssetAllocationStackedBarCustomizer implements JRChartCustomizer {
	...
	public void customize(JFreeChart chart, JRChart jasperChart) {
		...
		renderer.setBaseItemLabelFont(itemLabelFont.deriveFont(new Float(10.0)));
